	...
	implements ActionListener {//creating own button class
		...
		public void actionPerformed(ActionEvent e) { // placing x or o's
            ...
            if(win == true){ // if the game ends let the user know who wins and give option to play again
				ImageIcon icon = new ImageIcon("images/print.png","the winning player");
				JLabel label1 = new JLabel("Look who won the game! Do you want to try to beat him again?",icon,JLabel.CENTER);
				again=JOptionPane.showConfirmDialog(null, label1,"The agent won!",JOptionPane.YES_NO_OPTION);
